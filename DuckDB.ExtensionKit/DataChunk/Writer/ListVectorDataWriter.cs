...
internal sealed unsafe class ListVectorDataWriter : VectorDataWriterBase
{
    ...
    {
        childType = IsList ? NativeMethods.NativeMethods.LogicalType.DuckDBListTypeChildType(logicalType) : NativeMethods.NativeMethods.LogicalType.DuckDBArrayTypeChildType(logicalType);
        ...
        arraySize = IsList ? 0 : NativeMethods.NativeMethods.LogicalType.DuckDBArrayVectorGetSize(logicalType);
    ...
    private void ResizeVector(ulong rowIndex, ulong count)
    {
        ...
        var state = NativeMethods.NativeMethods.Vectors.DuckDBListVectorReserve(Vector, vectorReservedSize);
